...
export const MarathiPreSaleNOC: React.FC<{ data: AgreementData }> = ({ data }) => {
    ...
    <div id="printable-document" className="flex flex-col items-center">
      ...
      <div className="a4-page">
        ...
        <div className="mt-10 text-center font-serif text-[19px] font-bold tracking-[1.5px] uppercase text-indigo-600 underline underline-offset-4">
          अनापत्ती प्रमाणपत्र / तात्पुरते
        </div>
        <div className="text-center text-[13px] font-semibold mt-1 mb-6 text-gray-600">
          (विक्रीपूर्व — विक्रीपत्राच्या अंमलबजावणीपूर्वी)
        </div>
        ...
        <div className="clause" style={{ marginBottom: '14px', marginTop: '10px' }}>
          <strong>विषय:</strong> भूखंड क्र. <span className="underline-blank">{safeMarathi(data.property.plotNumber)}</span>, प्रकल्प <span className="underline-blank">{safeMarathi(data.property.projectName)}</span>, मौजा <span className="underline-blank">{safeMarathi(data.property.locality)}</span>, तालुका <span className="underline-blank">{safeMarathi(data.property.tehsil)}</span>, जिल्हा <span className="underline-blank">{safeMarathi(data.property.district)}</span> यांच्या खरेदी व नोंदणीसाठी अनापत्ती प्रमाणपत्र.
        </div>
        ...
        <table className="property-table">
          <tbody>
            ...
            <tr><td>मान्य विक्री किंमत</td><td>₹ {formatAmountMarathi(data.property.totalAmount)} /- मात्र</td></tr>
            <tr><td>टोकन / आगाऊ रक्कम</td><td>₹ {formatAmountMarathi(data.property.tokenAmount)} /- मात्र</td></tr>
            <tr><td>बुकिंग दिनांक</td><td>{formatMarathiDate(data.property.bookingDate)}</td></tr>
          </tbody>
        </table>

        <div className="clause">
          <span className="clause-num">१. </span>
          हे प्रमाणित केले जाते की {companyDisplay}, वर वर्णन केलेल्या मालमत्तेचे मालक व विकसक, <strong>{clientName}</strong> यांच्या बाजूने भूखंड क्र. {safeMarathi(data.property.plotNumber)}, क्षेत्रफळ {plotArea} चौरस फूट, <strong>{safeMarathi(data.property.projectName)}</strong> प्रकल्पातील, मौजा {safeMarathi(data.property.locality)}, तालुका {safeMarathi(data.property.tehsil)}, जिल्हा {safeMarathi(data.property.district)} यांच्या खरेदी, नोंदणी व सर्व कायदेशीर व्यवहारांसाठी हे अनापत्ती प्रमाणपत्र जारी करतात.
        </div>

        <div className="clause">
          <span className="clause-num">२. </span>
          {companyDisplay} यांनी घोषित केले की वरील मालमत्ता या प्रमाणपत्राच्या जारी करण्याच्या तारखेपर्यंत सर्व <strong>भार, शुल्क, तारण, विवाद, खटला, जप्ती</strong> आणि इतर कोणत्याही कायदेशीर किंवा आर्थिक दायित्वांपासून मुक्त आहे. कोणत्याही तृतीय पक्षाचा उक्त मालमत्तेवर कोणताही पूर्व दावा, हक्क किंवा हित नाही.
        </div>

        <div className="clause">
          <span className="clause-num">३. </span>
          {companyDisplay} पुढे घोषित करतात की उक्त भूखंड पूर्वी कोणत्याही व्यक्ती किंवा संस्थेला विकला, हस्तांतरित, भेट दिलेला, तारण ठेवलेला किंवा नियुक्त केलेला नाही, आणि {companyDisplay} यांच्याकडे उक्त मालमत्तेचे कायदेशीर, स्पष्ट आणि विक्रीयोग्य मालकी हक्क आहे व त्यांना ती विकण्याचा व हस्तांतरित करण्याचा पूर्ण अधिकार आहे.
        </div>

        <div className="clause">
          <span className="clause-num">४. </span>
          {companyDisplay} यांना <strong>कोणतीही हरकत नाही</strong> की {clientName} विक्रीपत्राच्या अंमलबजावणी, संबंधित उप-नोंदणीकरांसमोर त्यांच्या नावावर मालमत्तेची नोंदणी, तसेच योग्य नोंदणीनंतर उक्त भूखंडावर कोणतेही बांधकाम, विकास किंवा इतर कायदेशीर क्रियाकलाप करू शकतात.
        </div>

        <div className="clause">
          <span className="clause-num">५. </span>
          {companyDisplay} वचन देतात की या प्रमाणपत्राच्या जारी केल्यानंतर कोणत्याही तृतीय पक्षाद्वारे उक्त मालमत्तेवर कोणताही कायदेशीर विवाद, दावा किंवा भार उद्भवल्यास {companyDisplay} पूर्णपणे जबाबदार असतील आणि {clientName} यांना होणारे सर्व नुकसान, खर्च व हानीची भरपाई करतील.
        </div>

        <div className="clause">
          <span className="clause-num">६. </span>
          हे अनापत्ती प्रमाणपत्र दोन्ही पक्षांमध्ये {formatMarathiDate(data.property.bookingDate)} रोजी अंमलात आलेल्या विक्री करार / टोकन पावतीच्या आधारे सद्भावनेने जारी केले जात आहे, आणि ते पक्षकारांमध्ये विक्रीपत्राच्या अंमलबजावणी व नोंदणीपर्यंत वैध राहील. हे प्रमाणपत्र {companyDisplay}, त्यांचे उत्तराधिकारी, वारस व कायदेशीर प्रतिनिधी यांच्यासाठी बंधनकारक आहे.
        </div>
        ...
        <div className="notice-box" style={{ marginTop: '14px' }}>
          ...
          <div style={{ fontSize: '12px', color: '#555' }}>
            खालील कलम (७–११) {clientName} यांना भूखंड क्र. {safeMarathi(data.property.plotNumber)} यांच्या संदर्भात लागू होणाऱ्या अटी, दायित्वे व शुल्क निर्धारित करतात. या अटी या तात्पुरत्या अनापत्ती प्रमाणपत्राचा अविभाज्य भाग आहेत आणि खरेदीदारासाठी बंधनकारक आहेत.
          </div>
        </div>
...
export default MarathiPreSaleNOC;