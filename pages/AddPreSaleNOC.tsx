...
export const AddPreSaleNOC: React.FC = () => {
  ...
  return (
    <div className="max-w-5xl mx-auto space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-bold text-spiritual-maroon">Generate Pre-Sale NOC</h1>
          <p className="text-slate-500">Create a No Objection Certificate before property registration</p>
        </div>
        <button 
          onClick={() => navigate(-1)}
      ...
      {showPreview && selectedLang && (
        <AgreementPreview
          type="noc" // This will need to be handled by AgreementPreview to pick the right sheet
